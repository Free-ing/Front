...
class SpiritDailyRoutine {
  final String? timestamp;
  final bool? success;
  final String? code;
  final String? message;
  final List<SpiritRoutineDetail>? result;
  ...
  factory SpiritDailyRoutine.fromJson(Map<String, dynamic> json) {
    var resultList = json['result'] as List<dynamic>?;

    return SpiritDailyRoutine(
      timestamp: json['timestamp'],
      success: json['success'],
      code: json['code'],
      message: json['message'],
      result: resultList?.map((item) => SpiritRoutineDetail.fromJson(item)).toList(),
    );
  }
...
class SpiritRoutineDetail {
  ...
  factory SpiritRoutineDetail.fromJson(Map<String, dynamic> json) {
